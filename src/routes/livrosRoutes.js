...
//Definição de Rotas:
routes.get("/livros", LivroController.listarLivros, paginar);                    //http://localhost:3000/livros        
routes.get("/livros/busca", LivroController.listarLivroPorFiltro, paginar);    //http://localhost:3000/livros/busca?editora=Classicos
